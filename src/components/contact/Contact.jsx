...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_81lp4vi', 'template_eiv7omj', form.current, {
        publicKey: '8Uu3DD7zbG5HCAQVX',
      })
      .then(
        () => {
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">teslarohit369@gmail.com</span>
                        <a href="mailto:teslarohit369@gmail.com.com" className="contact__button">
